...
foreach country of local countries {
	...
	dfuller `var' if Country == "`country'", `testSpec'
...
xtunitroot ips GDPPerCapRealLCU if Year >= 1993
xtunitroot ips GDPPerCapRealLCU if Year >= 1993, trend
xtunitroot ips GDPPerCapRealLCU if Year >= 1993, demean
xtunitroot llc GDPPerCapRealLCU if Year >= 1993, lags(aic 4)
xtunitroot llc GDPPerCapRealLCU if Year >= 1993, trend
