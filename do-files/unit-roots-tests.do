...
scalar criticalValue = -3.0
local testSpec "nocons"
local test "G"

levels(Country), local(countries)
putexcel set "/Users/caw6/Desktop/UrbanizationCauseConsequence/test-results/GDPLCU_results.xlsx", modify
...
foreach country of local countries {
	...
	quietly dfuller GDPRealLCU if Country == "`country'", `testSpec'
