...
//putexcel set "/Users/caw6/Desktop/UrbanizationCauseConsequence/test-results/Vargranger_results.xlsx", modify sheet("cum_Govt")
...
local row "2"
foreach country of local countries {
	quietly var PctPopUrban cum_Govt if Country == "`country'"
	vargranger 
