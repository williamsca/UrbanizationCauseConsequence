...
use "/Users/caw6/Desktop/UrbanizationCauseConsequence/data/WDIcointegrated.dta"
...
local var "GDPPerCapRealUSD"
local test "P"

levels(Country), local(countries)
putexcel set "/Users/caw6/Desktop/UrbanizationCauseConsequence/test-results/Voice_results.xlsx", modify
...
foreach country of local countries {
	...
	quietly dfuller `var' if Country == "`country'", `testSpec'
