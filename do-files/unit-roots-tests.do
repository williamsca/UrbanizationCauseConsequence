...
putexcel set "/Users/caw6/Desktop/UrbanizationCauseConsequence/test-results/GDPPerCap_results.xlsx", modify
...
foreach country of local countries {
	...
	quietly dfuller GDPPerCapRealUSD if Country == "`country'", `testSpec'
